...
<head>
	...
	function drawImage(imageObj) {
		...
		shuffleMax       =  parseInt(totalPieces/2) - 1;
...
<body>
    ...
    <div class='main_page'>
        ...
        <img id='thumbimage2' style='display:none;' onload='drawImage(this);' alt='' />
    
    	<img src='./gfx/info.png' onmouseover="this.style.cursor='pointer';" onmouseout="this.style.cursor='default';" onclick="showInfo(event);"
